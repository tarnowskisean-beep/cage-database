        ...
        <div className="max-w-[1200px] mx-auto px-6 py-12">
            <header className="flex justify-between items-start mb-12">
                ...
                <div className="flex gap-4">
                    <Link href="/people/resolution" className="px-4 py-2 border border-yellow-500/30 text-yellow-500 rounded hover:bg-yellow-500/10 transition-colors text-sm font-medium flex items-center gap-2">

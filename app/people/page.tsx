        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <header className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <form onSubmit={handleSearch} className="flex gap-2 w-full md:w-auto relative group">
                    ...
                    <input
                        type="text"
                        className="bg-[#1f1f1f] border border-[var(--color-border)] rounded text-white px-12 py-3 w-full md:w-96 outline-none focus:border-[var(--color-accent)] transition-all placeholder-gray-600 font-light"
